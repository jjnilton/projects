...
![Event Countdown Timer](screencast.gif)
...
- [x] Notification with Notification Web API
- [x] Play sound when event timer is complete
- [x] Delete event timer
- [x] List completed/expired timers
- [x] Clear completed/expired timers
- [x] Sort timers ascending
- [x] Handle keyboard focus
